...
void prepareShader() {
    shader = new Shader("assets/shaders/17_texture_wrap/vertex_offset.glsl", "assets/shaders/17_texture_wrap/fragment.glsl");
}
...
void prepareTexture() {
    ...
    //由于前面已经激活纹理单元，并且绑定了纹理，这里如果解绑会导致纹理单元中无纹理
