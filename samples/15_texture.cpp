...
void prepareShader() {
    //shader = new Shader("assets/shaders/14_uniform/vertex.glsl", "assets/shaders/14_uniform/fragment.glsl");
    shader = new Shader("assets/shaders/14_uniform/vertex_offset.glsl", "assets/shaders/14_uniform/fragment.glsl");
}
